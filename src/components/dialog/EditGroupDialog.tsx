...
type EditGroupDialogProps = {
  ...
  onClose: () => void;
  onSave: (updatedGroup: UserGroupResponse) => void;
...
export default function EditGroupDialog({
  ...
  const [checkedUserIds, setCheckedUserIds] = useState<number[]>(
    group ? [...group.members.map((member) => member.id), group.creator.id] : [],
  );
            ...
            >
              {isLoadingAllUsers ? (
                ...
                <>
                  <ListItem
                    disablePadding
                    secondaryAction={<Checkbox edge="end" checked disabled />}
                  >
                    <ListItemButton disabled>
                      ...
                      >
                        <Blobatar name={user.username} width={32} height={32} />
                      </div>
                      <ListItemText primary={`${user.username} (Du)`} />
                    </ListItemButton>
                  </ListItem>
